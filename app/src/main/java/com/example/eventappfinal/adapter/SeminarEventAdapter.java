...
public class SeminarEventAdapter extends RecyclerView.Adapter<SeminarEventAdapter.ViewHolder>{
    ...
    public SeminarEventAdapter(SeminarFragment seminarFragment, ArrayList nameList, ArrayList contentList, ArrayList idList, ArrayList emailList, ArrayList dateList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            mRecyclerView = itemView.findViewById(R.id.recyclerSeminar);
