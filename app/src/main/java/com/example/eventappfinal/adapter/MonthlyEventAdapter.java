...
public class MonthlyEventAdapter extends RecyclerView.Adapter<MonthlyEventAdapter.ViewHolder>{
    ...
    public MonthlyEventAdapter(MonthlyEventFragment monthlyEventAdapter, ArrayList nameList, ArrayList contentList, ArrayList idList, ArrayList emailList, ArrayList dateList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            mRecyclerView = itemView.findViewById(R.id.recyclerMonthly);
