...
public class WeeklyEventAdapter extends RecyclerView.Adapter<WeeklyEventAdapter.ViewHolder>{
    ...
    public WeeklyEventAdapter(WeeklyEventFragment weeklyEventFragment, ArrayList nameList, ArrayList contentList, ArrayList idList, ArrayList emailList, ArrayList dateList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            mRecyclerView = itemView.findViewById(R.id.recyclerWeekly);
