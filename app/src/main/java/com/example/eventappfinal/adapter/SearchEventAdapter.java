...
public class SearchEventAdapter extends RecyclerView.Adapter<SearchEventAdapter.ViewHolder>{
    ...
    public SearchEventAdapter(SearchFragment searchFragment, ArrayList nameList, ArrayList contentList, ArrayList idList, ArrayList emailList, ArrayList dateList) {
